export type Province = { name: string; districts: string[] }
...
export const provinces: Province[] = [
  ...
  { name: "Samsun", districts: ["Alaçam", "Asarcık", "Atakum", "Ayvacık", "Bafra", "Canik", "Çarşamba", "Havza", "İlkadım", "Kavak", "Ladik", "Salıpazarı", "Tekkeköy", "Terme", "Vezirköprü", "Yakakent", "19 Mayıs"] },
  ...
  { name: "Van", districts: ["Bahçesaray", "Başkale", "Çatak", "Çaldıran", "Edremit", "Erciş", "Gevaş", "Gürpınar", "İpekyolu", "Muradiye", "Özalp", "Saray", "Tuşba"] },
  ...
  { name: "Zonguldak", districts: ["Alaplı", "Çaycuma", "Devrek", "Gökçebey", "Kilimli", "Kozlu", "Merkez"] },
]
