...
const EVENT_ICONS: Record<string, { color: string; icon: string; label: string }> = {
  ...
  // dot-notation aliases (seed data / legacy format)
  "appointment.confirmed": { color: "bg-emerald-500", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", label: "Randevu Onayı" },
  "appointment.cancelled": { color: "bg-red-500", icon: "M6 18L18 6M6 6l12 12", label: "Randevu İptali" },
  "appointment.reminder": { color: "bg-amber-500", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", label: "Hatırlatma" },
  "appointment.created": { color: "bg-blue-500", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", label: "Yeni Randevu" },
}
