      ...
      {state.step === 3 && (
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 text-sm rounded-xl border border-zinc-300 bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
            onChange={(e) => {
