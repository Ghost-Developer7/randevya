    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-[#2a5cff] rounded-xl hover:opacity-90 transition-opacity shrink-0"
        >
      ...
      {createOpen && (
        <NewAppointmentModal
          ...
          onCreated={() => { setCreateOpen(false); fetchAppointments() }}
        />
      )}
