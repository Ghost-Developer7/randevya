    ...
    try {
      ...
      if (result?.ok) {
        ...
        if (session?.user?.role === "TENANT_OWNER" || session?.user?.role === "PLATFORM_ADMIN") {
          ...
          setError("Bu hesap bir işletme hesabı değil. Bireysel giriş için müşteri giriş sayfasını kullanın.")
        }
      } else {
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-zinc-600">
            İşletme panelinize erişim için giriş yapın
          </p>
